...
if ~isempty(varargin) && ischar(varargin{end-1}) && strcmp(varargin{end-1},'Parent')
    f=varargin{end};
...
if Args.Holdaxis
    h=axes('position',[xpos1 1-ypos2 xpos2-xpos1 ypos2-ypos1],'Parent',f);
else
    h=subplot('position',[xpos1 1-ypos2 xpos2-xpos1 ypos2-ypos1],'Parent',f);
end
