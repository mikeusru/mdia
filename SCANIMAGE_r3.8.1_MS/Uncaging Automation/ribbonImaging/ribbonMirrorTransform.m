...
scaledMirrorDataOutput=scaledMirrorDataOutput-dia.acq.ribbon.mirrorOffset;
...
%offset for slow scanning line should be based on distance of the input
%line from center of image
% dia.acq.ribbonTheta=theta;
% dia.acq.ribbonPixelsPerLine=state.acq.pixelsPerLine;
% dia.acq.ribbonLinesPerFrame=state.acq.linesPerFrame;
% dia.acq.ribbonMask=BW;
% disp('Ribbon Created');
