function setupInitialImagingTimers
%setupInitialImagingTimers sets up and starts the pre-uncaging timers
...
ua.timers.preUncageDisplayFOVtimer=timer('TimerFcn',...
    ...
    'Period',1,'ExecutionMode','fixedRate','Name','initialImagingDisplayFOVtimer');
...
ua.timers.preUncageActionFOVtimer=timer('TimerFcn',...
    ...
    'TasksToExecute', ua.uncageTasks, 'Period',dia.acq.initialImagingPeriod,...
    'ExecutionMode','fixedRate','Name','initialImagingActionFOVtimer');
