...
siz = [spc.size(1), spc.SPCdata.scan_size_y*spc.SPCdata.scan_rout_x, spc.SPCdata.scan_size_x];
...
if append
    ...
    imwrite(saveimage, fname, 'WriteMode', 'overwrite', 'compression', 'lzw', 'Description', spc.headerstr);
end
