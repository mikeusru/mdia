classdef MP285 < dabs.interfaces.LSCSerial
    ...
    properties (Constant,Hidden)        
        ...
        initialVelocity = 50; %Start at max velocity in fine resolution mode %MISHA - Changed value from 1300
        maxVelocityFine = 200; %Max velocity in fine resolution mode %MISHA - Changed value from 1300
    end
    ...
    methods
        ...
        function v = get.positionAbsoluteRaw(obj)
            try %RYOHEI %For some reason this decreases the crush.
                pause(.1); %MISHA - this prevented a crash where it doesn't get the position
