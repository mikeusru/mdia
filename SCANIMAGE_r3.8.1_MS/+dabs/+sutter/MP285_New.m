classdef MP285 < dabs.interfaces.LSCSerial
    ...
    methods
        ...
        function v = get.positionAbsoluteRaw(obj)
            ...
            fclose(obj.hRS232.hSerial);
            posn = dabs.sutter.MP285Commander(obj.hRS232.hSerial.port, obj.hRS232.hSerial.BaudRate, 'c');
            v = posn(:)';
        end
    ...
    methods (Access=private)
        ...
        function val = zprpGetStatusProperty(obj,statusProp)
            fclose(obj.hRS232.hSerial);
            status = dabs.sutter.MP285Commander(obj.hRS232.hSerial.port, obj.hRS232.hSerial.BaudRate, 's'); %obj.getStatus();
        ...
        function zprpSetVelocityAndResolutionOnDevice(obj)
            ...
            fclose(obj.hRS232.hSerial);
            dabs.sutter.MP285Commander(obj.hRS232.hSerial.port, obj.hRS232.hSerial.BaudRate, 'v', commandValue);
        end
    ...
    methods (Access=protected,Hidden)
        ...
        function moveStartHook(obj,absTargetPosn)
            ...
            fclose(obj.hRS232.hSerial);
            dabs.sutter.MP285Commander(obj.hRS232.hSerial.port, obj.hRS232.hSerial.BaudRate, 'ma', absTargetPosn);
...
%             obj.hRS232.readStringRaw(); % read CR response
              fclose(obj.hRS232.hSerial);
              dabs.sutter.MP285Commander(obj.hRS232.hSerial.port, obj.hRS232.hSerial.BaudRate, 'r');
        end
        ...
        function resetHook(obj)
            ...
            %obj.hRS232.sendCommand('n');
            dabs.sutter.MP285Commander(obj.hRS232.hSerial.port, obj.hRS232.hSerial.BaudRate, 'n');
        ...
        function zeroHardHook(obj,coords)
           ...
           fclose(obj.hRS232.hSerial);
           dabs.sutter.MP285Commander(obj.hRS232.hSerial.port, obj.hRS232.hSerial.BaudRate, 'o');
...
%             obj.hRS232.readBinaryRaw(1); % trailing CR
            status = dabs.sutter.MP285Commander(obj.hRS232.hSerial.port, obj.hRS232.hSerial.BaudRate, 's');
